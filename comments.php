...
?>
	...
	<br />
	<h2 id="mentions"><?php// echo count($wp_query->comments_by_type['pings']); ?>Readers who shared <em><?php the_title(); ?></em></h2>
	        <ol class="commentlist">
	                <?php wp_list_comments('type=pings&callback=cleanr_theme_pings'); ?>
	        </ol>
	<?php } ?>
	<?php endif; ?>
